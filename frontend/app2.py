...
model_names = ["All","Cervix","Lung","Oral","Kidney","Breast","Brain","lymph","DenseNet201"]
...
class_names = {
    ...
    'DenseNet201': ['ALL', 'Brain', 'Breast', 'Cervical', 'kidney', 'lung and colon', 'lymph', 'oral'],
}
...
if st.button("Load Model"):
    if selected_model == "All":
        ...
        model_path = "D:\SIG\FInal Year Project\Codes, Simulations and GUI\.h5 files\Multi Cancer DenseNet201.h5"
        num_classes = 8 # Update the number of classes
        model = load_densenet201_model(model_path, num_classes)
        if model is not None:
            st.success("Densenet201 model loaded successfully.")
